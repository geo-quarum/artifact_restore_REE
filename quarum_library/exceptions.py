...
class NormalizationError(Exception):
    "The data is expected to be normalized, but normalization reference is missing in function invocation"
    pass


class ConfigurationError(Exception):
    "There is something wrong in the configuration of the script."
    pass